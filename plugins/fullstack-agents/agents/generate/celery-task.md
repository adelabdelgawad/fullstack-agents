...
1. **Pattern compliance review** — Check generated Celery task against codebase profile:
   - Task decorator configuration matches existing tasks
   - Retry policy and error handling follow conventions
   - Import style and module structure match existing tasks
